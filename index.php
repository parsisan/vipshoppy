	...
	<div class="well np">
		<div id="myCarousel" class="carousel slide homCar">
            <div class="carousel-inner">
				...
				$Slider_OBJ = new ProductsModel();
				$resultSliders = $Slider_OBJ->GetProductsSlider(1);
				
				foreach ($resultSliders as $key => $slideItem) {
				?>
				<div class="item <?php if($slideItem["placement"] == 1){
					echo "active";
				}
				else
				{
				...
				?>">
                <img style="width:100%" src="<?php echo $siteURL; ?>/public/images/sliders/<?php echo $slideItem["picURL"]; ?>" alt="bootstrap ecommerce templates">
                <div class="carousel-caption">
                      <h4><?php echo $slideItem["title"]; ?></h4>
                      <p><span><?php echo $slideItem["description"]; ?></span></p>
                </div>
              </div>
